...
class DengShanLiFasterRCNNDetector(pl.LightningModule):
    def __init__(self, **kwargs):
        super().__init__()
        conv11 = nn.Conv2d(3,64,3,1)
        conv12 = nn.Conv2d(64,64,3,1)
        conv13 = nn.Conv2d(64,64,3,1)
        relu = nn.ReLU()
        lrn = nn.LocalResponseNorm(5,alpha=0.0005,beta=0.75,k=2)
        max_pool = nn.MaxPool2d(2,2)
        conv21 = nn.Conv2d(64,128,3,1)
        conv22 = nn.Conv2d(128,128,3,1)
        conv23 = nn.Conv2d(128,128,3,1)

        conv31 = nn.Conv2d(128,256,3,1)
        conv32 = nn.Conv2d(256,256,3,1)
        conv33 = nn.Conv2d(256,256,3,1)

        conv41 = nn.Conv2d(256,512,3,1)
        conv42 = nn.Conv2d(512,512,3,1)
        conv43 = nn.Conv2d(512,512,3,1)
